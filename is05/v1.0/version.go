...
func (v *IS05V1_0) ConnectionPostBulkSenders(senders []BulkSenderPost) ([]BulkResponse, Error, error) {
...
func (v *IS05V1_0) ConnectionPostBulkReceivers(receivers []BulkReceiverPost) ([]BulkResponse, Error, error) {
...
func (v *IS05V1_0) ConnectionGetSenderConstraints(senderID string) ([]Constraints, Error, error) {
...
func (v *IS05V1_0) ConnectionGetSenderTransportFile(senderID string) (string, Error, error) {
...
func (v *IS05V1_0) ConnectionGetReceiverConstraints(receiverID string) ([]Constraints, Error, error) {
