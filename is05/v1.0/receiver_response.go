...
type ReceiverResponse struct {
	...
	TransportFile   ReceiverResponseTransportFile `json:"transport_file"`   // Transport file parameters. 'data' and 'type' must both be strings or both be null
...
type ReceiverResponseTransportFile struct {
