...
type Constraint struct {
	Maximum     int    `json:"maximum,omitempty"`     // The inclusive maximum value the parameter can be set to
	Minimum     int    `json:"minimum,omitempty"`     // The inclusive minimum value the parameter can be set to
