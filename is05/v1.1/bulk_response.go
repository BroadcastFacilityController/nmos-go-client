...
type BulkResponse struct {
	...
	Code  int         `json:"code,omitempty"`  // HTTP status code that would have resulted from an individual activation on this device
	...
	Debug null.String `json:"debug,omitzero"`  // Debug information which may assist a programmer working with the API. Only included if 'code' indicates an error state
}
