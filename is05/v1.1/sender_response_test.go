...
func TestSenderGetActive(t *testing.T) {
	dataStr := "{\"receiver_id\":\"0a174530-e3cf-11e6-bf01-fe55135034f3\",\"master_enable\":true,\"activation\":{\"mode\":\"activate_immediate\",\"requested_time\":\"1496759200:0\",\"activation_time\":\"1496759200:0\"},\"transport_params\":[{\"source_ip\":\"172.29.82.23\",\"destination_ip\":\"172.29.82.95\",\"source_port\":5000,\"destination_port\":5000,\"fec_enabled\":true,\"fec_destination_ip\":\"172.29.82.95\",\"fec_type\":\"XOR\",\"fec_mode\":\"2D\",\"fec_block_width\":50,\"fec_block_height\":50,\"fec1D_destination_port\":5002,\"fec2D_destination_port\":5004,\"fec1D_source_port\":5002,\"fec2D_source_port\":5004,\"rtcp_enabled\":true,\"rtcp_destination_ip\":\"172.29.82.24\",\"rtcp_destination_port\":5008,\"rtcp_source_port\":5008,\"rtp_enabled\":true},{\"source_ip\":\"172.30.82.23\",\"destination_ip\":\"172.30.82.95\",\"source_port\":5000,\"destination_port\":5000,\"fec_enabled\":true,\"fec_destination_ip\":\"172.30.82.95\",\"fec_type\":\"XOR\",\"fec_mode\":\"2D\",\"fec_block_width\":50,\"fec_block_height\":50,\"fec1D_destination_port\":5002,\"fec2D_destination_port\":5004,\"fec1D_source_port\":5002,\"fec2D_source_port\":5004,\"rtcp_enabled\":true,\"rtcp_destination_ip\":\"172.30.82.24\",\"rtcp_destination_port\":5008,\"rtcp_source_port\":5008,\"rtp_enabled\":true}]}"
	data := []byte(dataStr)
...
func TestSenderGetActiveUninit(t *testing.T) {
...
func TestSenderGetActiveMQTT(t *testing.T) {
	dataStr := "{\"receiver_id\":\"69744dfb-0557-4202-b1f1-4d1a741ee2bb\",\"master_enable\":true,\"activation\":{\"mode\":\"activate_immediate\",\"requested_time\":\"1541508905:0\",\"activation_time\":\"1541508905:0\"},\"transport_params\":[{\"destination_host\":\"broker.example.com\",\"destination_port\":1883,\"broker_topic\":\"my_topic_name\",\"broker_protocol\":\"mqtt\",\"broker_authorization\":false,\"connection_status_broker_topic\":\"my_status_topic_name\"}]}"
	data := []byte(dataStr)
	var test SenderResponse
	err := json.Unmarshal(data, &test)
	if err != nil {
...
func TestSenderStagedAbsolute(t *testing.T) {
...
func TestSenderStagedRelative(t *testing.T) {
...
func TestSenderStagedRedundant(t *testing.T) {
...
func TestSenderStaged(t *testing.T) {
	dataStr := "{\"master_enable\":true,\"receiver_id\":null,\"activation\":{\"mode\":\"activate_immediate\",\"requested_time\":null,\"activation_time\":null},\"transport_params\":[{\"source_ip\":\"192.168.200.10\",\"destination_ip\":\"232.105.26.177\",\"source_port\":5000,\"destination_port\":5000,\"fec_enabled\":true,\"fec_type\":\"XOR\",\"fec_mode\":\"2D\",\"fec_block_width\":50,\"fec_block_height\":50,\"fec1D_destination_port\":\"auto\",\"fec2D_destination_port\":\"auto\",\"fec1D_source_port\":5010,\"fec2D_source_port\":5012,\"rtcp_enabled\":true,\"rtcp_destination_ip\":\"232.22.4.59\",\"rtcp_destination_port\":5008,\"rtcp_source_port\":5008,\"rtp_enabled\":true}]}"
	data := []byte(dataStr)
	var test SenderResponse
	err := json.Unmarshal(data, &test)
