...
func (v *IS05V1_1) ConnectionGetSenderStaged(senderID string) (SenderResponse, Error, error) {
...
func (v *IS05V1_1) ConnectionPatchSenderStaged(senderID string, senderStaged SenderStage) (SenderResponse, Error, error) {
...
func (v *IS05V1_1) ConnectionGetSenderActive(senderID string) (SenderResponse, Error, error) {
...
func (v *IS05V1_1) ConnectionGetReceiverStaged(receiverID string) (ReceiverResponse, Error, error) {
...
func (v *IS05V1_1) ConnectionPatchReceiverStaged(receiverID string, receiverStaged ReceiverStage) (ReceiverResponse, Error, error) {
...
func (v *IS05V1_1) ConnectionGetReceiverActive(receiverID string) (ReceiverResponse, Error, error) {
