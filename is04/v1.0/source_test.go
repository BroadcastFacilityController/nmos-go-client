...
func TestNodeAPISourceIDGet(t *testing.T) {
	dataStr := "{\"description\":\"Capture Card Source Video\",\"tags\":{\"host\":[\"host1\"]},\"format\":\"urn:x-nmos:format:video\",\"caps\":{},\"version\":\"1441703336:902850419\",\"parents\":[],\"label\":\"CaptureCardSourceVideo\",\"id\":\"4569cea2-ab63-4f97-8dd1-bad4669ea5e4\",\"device_id\":\"9126cc2f-4c26-4c9b-a6cd-93c4381c9be5\"}"
	data := []byte(dataStr)
	var test Source
...
func TestQueryAPISourceIDGet(t *testing.T) {
	dataStr := "{\"description\":\"Capture Card Source Video\",\"format\":\"urn:x-nmos:format:video\",\"tags\":{\"SourceDeviceType\":[\"HD Camera\"],\"host\":[\"host1\"],\"Location\":[\"Location 1\"]},\"caps\":{},\"version\":\"1441722516:851371645\",\"parents\":[],\"label\":\"CaptureCardSourceVideo\",\"id\":\"c23c6a65-8e91-4f6c-a484-046363dbca29\",\"device_id\":\"65fa8c20-890e-4b86-87b2-cfd9df91b7f8\"}"
	data := []byte(dataStr)
	var test Source
	err := json.Unmarshal(data, &test)
	if err != nil {
...
func TestQueryAPISourcesGet(t *testing.T) {
	dataStr := "[{\"description\":\"Camera 1\",\"format\":\"urn:x-nmos:format:video\",\"tags\":{\"SourceDeviceType\":[\"UHD Camera\"],\"host\":[\"host1\"],\"location\":[\"Location 1\"]},\"caps\":{},\"version\":\"1441724551:288670563\",\"parents\":[],\"label\":\"Camera 1\",\"id\":\"042a4126-0208-443d-bda6-833ffc27ed51\",\"device_id\":\"21a28338-fb2e-4df5-9b55-d58e6124bc9f\"},{\"description\":\"Camera 2\",\"format\":\"urn:x-nmos:format:video\",\"tags\":{\"SourceDeviceType\":[\"HD Camera\"],\"host\":[\"host2\"],\"Location\":[\"Location 2\"]},\"caps\":{},\"version\":\"1441722516:851371645\",\"parents\":[],\"label\":\"CaptureCardSourceVideo\",\"id\":\"c23c6a65-8e91-4f6c-a484-046363dbca29\",\"device_id\":\"65fa8c20-890e-4b86-87b2-cfd9df91b7f8\"},{\"description\":\"Audio 1\",\"format\":\"urn:x-nmos:format:audio\",\"tags\":{\"host\":[\"host3\"]},\"caps\":{},\"version\":\"1441719058:3226205\",\"parents\":[],\"label\":\"Audio 1\",\"id\":\"62cf8dd3-015b-49e3-84c1-1d866a7540bc\",\"device_id\":\"e7aa15c4-f793-4d43-a0cb-c638db6215ac\"}]"
	data := []byte(dataStr)
	var test []Source
	err := json.Unmarshal(data, &test)
	if err != nil {
