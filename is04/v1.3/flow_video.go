...
type FlowVideo struct {
	...
	InterlaceMode          FlowVideoInterlaceMode          `json:"interlace_mode,omitempty"`          // Interlaced video mode for frames in this Flow
	Colorspace             FlowVideoColorspace             `json:"colorspace"`                        // Colorspace used for the video
	TransferCharacteristic FlowVideoTransferCharacteristic `json:"transfer_Characteristic,omitempty"` // Transfer Characteristic
}
